            ...
            <div className="leading-none">
              ...
              {(financials.dailyFinancingCost ?? 0) > 0.5 ? (
                <div className="flex flex-col">
                  ...
                  {(financials.dailyTrustBonus ?? 0) > 0.5 && (
                    <div className="text-[9px] font-mono text-violet-300">+${Math.round(financials.dailyTrustBonus ?? 0).toLocaleString()}/d trust</div>
                  )}
                  {Math.abs(financials.dailySeasonalBonus ?? 0) > 0.5 && (
                  ...
                  {(financials.dailyGreenBonus ?? 0) > 0.5 && (
                    <div className="text-[9px] font-mono text-emerald-300">+${Math.round(financials.dailyGreenBonus ?? 0).toLocaleString()}/d green</div>
                  )}
                </div>
              ) : (financials.dailyReclaimBonus ?? 0) > 0.5 || (financials.dailyTrustBonus ?? 0) > 0.5 || Math.abs(financials.dailySeasonalBonus ?? 0) > 0.5 || (financials.dailyBiosolidsBonus ?? 0) > 0.5 || (financials.dailyGreenBonus ?? 0) > 0.5 ? (
                <div className="flex flex-col">
                  ...
                  {(financials.dailyReclaimBonus ?? 0) > 0.5 && (
                    <div className="text-[9px] font-mono text-cyan-300">+${Math.round(financials.dailyReclaimBonus ?? 0).toLocaleString()} reclaim</div>
                  )}
                  {(financials.dailyTrustBonus ?? 0) > 0.5 && (
                    <div className="text-[9px] font-mono text-violet-300">+${Math.round(financials.dailyTrustBonus ?? 0).toLocaleString()} trust · {Math.round((gameState.complianceStreakDays ?? 0))}d streak</div>
                  )}
                  {Math.abs(financials.dailySeasonalBonus ?? 0) > 0.5 && (
                    <div className={`text-[9px] font-mono ${(financials.dailySeasonalBonus ?? 0) > 0 ? 'text-amber-300' : 'text-sky-300'}`}>
                  ...
                  {(financials.dailyGreenBonus ?? 0) > 0.5 && (
                    <div className="text-[9px] font-mono text-emerald-300">+${Math.round(financials.dailyGreenBonus ?? 0).toLocaleString()} green · {Math.round(overallStats.energySelfSufficiencyPercent)}% self</div>
                  )}
                </div>
              ) : (
                <div className="flex flex-col">
                  ...
                  {(financials.dailyGreenBonus ?? 0) > 0.5 && (
                    <div className="text-[9px] font-mono text-emerald-300">+${Math.round(financials.dailyGreenBonus ?? 0).toLocaleString()} green</div>
                  )}
                </div>
              )}
            </div>
